...
%token IMPORT OPC_OP CO_OP YIELD ARW_OP ASYNC
...
arrowFunction
  : IDENTIFIER ARW_OP IDENTIFIER
  ;

asyncArrowFunction
  : ASYNC assignmentExpression
  ;
...
coalesceExpression
  : coalesceExpressionHead CO_OP bitwiseOrExpression
  ;
